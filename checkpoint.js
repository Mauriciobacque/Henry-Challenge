...
Empleado.prototype.infoEmpleado = function(){
    return 'Nombre: ' + this.nombre + ', Salario: ' + this.salario;
}
console.log(nombre.infoEmpleado());
...
function index() {
  ...
  function encontraIndex(numeros) {   
...
function crearClaseEmpleado() {
  ...
  class Empleado {
    ...
    getTareas() {
      ...
      console.log(Object.values(tareas))
    }
